Package.describe({
    name: 'rwatts:orion-exporter',
    summary: 'Export and import all your Orion data',
    version: '1.1.2',
    git: 'https://github.com/rwatts3/orion-exporter'
});
...
Package.onUse(function (api) {
    ...
    api.use(['meteor-platform', 'orionjs:base@1.4.0', 'orionjs:dictionary@1.4.0', 'orionjs:collections@1.4.0', 'nicolaslopezj:roles@1.2.0', 'meteorhacks:picker@1.0.3', 'http','momentjs:moment@2.10.0']);
